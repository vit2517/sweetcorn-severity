                    ...
                    >
                      ...
                      <div class="row">
                        <div class="col-md-12 col-xs-12 q-pa-md">
                          <q-select
                            filled
                            v-model="modelChemical"
                            :options="optionsChemical"
                            label="การป้องกันด้วยสารเคมี"
                          />
                        </div>
                      </div>
                      <!--  ชนิดของสารเคมี + คำอธิบายวิธีการใช้สารเคมี + คุณสมบัติของสารเคมี-->
                      <div class="row">
                        <!--  ชนิดของสารเคมี -->
                        <div class="col-md-6 col-xs-12 q-pa-md">
                          <q-badge color="blue" multi-line v-if="modelChemical">
                            ชนิดของสารเคมี: "{{ modelChemical.label }}"
                          </q-badge>
                        </div>
                      </div>
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 col-xs-12 q-pa-md">
                          <q-badge color="blue" multi-line v-if="modelChemical">
                            คุณสมบัติของสารเคมี: "{{ modelChemical.property }}"
                          </q-badge>
                        </div>
                      </div>
                    </q-form>
      ...
      optionsChemical: [
        {
          ...
          value: "1",
          description:
            "ใช้เมทาแลกซิลในอัตรา 7-10 กรัม/เมล็ด 1 กิโลกรัม คลุกเมล็ดก่อนปลูก",
          property:
            "สามารถป้องกันกาจัดโรคราน้ำค้างได้ตลอดฤดูปลูกและเมื่อข้าวโพดอายุ 1 สัปดาห์ ให้พ่นทุกสัปดาห์ติดต่อกันจำนวน 4 สัปดาห์ สามารถป้องกันโรคราน้ำค้างได้ดีที่สุด",
        },
        {
          label: "เมทาแลกซิลเอ็ม 35% อีเอส",
          value: "2",
          description:
            "ใช้ในอัตรา 3-5 มิลลิลิตรต่อเมล็ดพันธุ์ 1 กิโลกรัม คลุกเมล็ดก่อนปลูก",
        ...
        },
        {
          ...
          value: "3",
          description:
            "คลุกเมล็ดก่อนปลูกด้วยสารเคมีไดเมทโทมอร์ฟ 20 กรัมต่อเมล็ด 1 กิโลกรัม และพ่นที่อัตรา 20 กรัมต่อน้า 20 ลิตร เมื่อข้าวโพดอายุ 10 วัน และพ่นทุก 7 วันรวม 3 ครั้ง ถ้าในแหล่งปลูกที่เคยมีการระบาดของโรคมีอุณหภูมิต่ำและมีความชื้นในอากาศสูง เมื่อต้นข้าวโพดมีอายุ 5-7 วัน ควรพ่นด้วยสารป้องกันกำจัดโรคพืช ไดเมโทมอร์ฟ 50 ดับเบิ้ลยูพี อัตรา 20-30 กรัมต่อน้ำ 20 ลิตร พ่นทุก 7 วัน และพ่นติดต่อกัน 3-4 ครั้ง",
          property:
            "สามารถควบคุมโรคราน้าค้างได้ดีที่สุด และมีเปอร์เซ็นต์การเป็นโรค 16.6 เปอร์เซ็นต์",
        },
        {
          label: "เมทาแลกซิล 25 ดับบลิวพี",
          value: "4",
          description:
            "ในแหล่งปลูกที่เคยมีการระบาดของโรค หากมีอุณหภูมิต่ำและมีความชื้นในอากาศสูง เมื่อต้นข้าวโพดมีอายุ 5-7 วัน ควรพ่นด้วยสารป้องกันกำจัดโรคพืช ด้วยเมทาแลกซิล 25 ดับบลิวพี ใช้ในอัตรา 30-40 กรัมต่อน้ำ 20 ลิตร พ่นทุก 7 วัน และพ่นติดต่อกัน 3-4 ครั้ง",
          property: "สามารถป้องกันกำจัดโรคน้ำค้าง",
        },
        {
          label: "สกอร์ (ไดพีโนคลอนาโซล 25 %)",
          value: "5",
          description:
            "ใช้ในอัตรา 20-30 ซีซี ต่อน้ำ 20 ลิตร พ่นทุก 7 วัน จำนวน 2-4 ครั้ง",
          property: "ป้องกันกำจัดการระบาดของโรคราสนิม",
        },
        {
          label: "แมนโคแซบ 80",
          value: "6",
          description:
            "ใช้ในอัตรา 40 กรัมต่อน้ำ 20 ลิตร  พ่นทุก 7 วัน จำนวน 2-4 ครั้ง",
          property: "สามารถป้องกันการระบาดของโรคราสนิม",
        },
        {
          label: "อามูเร่ 300 อีซี",
          value: "7",
          description:
            "ใช้ในอัตรา 15-20 ซีซี. ต่อน้ำ 20 ลิตร พ่นเมื่อพบการระบาดของโรคติดต่อกันทุก 7 วัน ระยะฉีดพ่นครั้งสุดท้ายก่อนเก็บเกี่ยวผลผลิตประมาณ 14 วัน",
          property: "สามารถป้องกันกำจัดโรคราสนิมและโรคใบไหม้แผลใหญ่",
        },
        {
          label: "อมิสตา อะซอกซีสโตรบิน 25%",
          value: "8",
          description:
            "ใช้ในอัตรา 5-10 มิลลิลิตรผสมน้ำ 20 ลิตร พ่นทุก 7-10 วัน",
          property: "สามารถป้องกันกำจัดโรคราสนิม",
        },
        {
          label: "ไตรโฟรีน 20 (ซาพรอล)",
          value: "9",
          description: "ใช้ในอัตรา 60 มิลลิลิตรต่อน้า 20 ลิตร พ่นทุก 7 วัน",
          property: "สามารถป้องกันการรระบาดของโรคใบไหม้แผลเล็ก",
        },
        {
          label: "บูลโลไซด์ (ซีเนบ)",
          value: "10",
          description:
            ",ใช้ในอัตรา 30 กรัมต่อน้ำ 20 ลิตร พ่นป้องกันการระบาดของโรคใบไหม้แผลเล็กและพ่นซ้ำทุก 7 วัน",
          property: "สามารถป้องกันกำจัดโรคใบไหม้แผลเล็ก",
        },
        {
          label: "เอร่า โพรพิเนบ",
          value: "11",
          description:
            "ใช้ในอัตรา 60 กรัมต่อน้ำ 20 ลิตร พ่น 2 ครั้ง ครั้งแรกเมื่อเริ่มพบการระบาดของโรคใบไหม้แผลเล็กและพ่นครั้งที่ 2 ห่างจากครั้งแรก 10 วัน",
          property: "สามารถป้องกันกำจัดโรคใบไหม้แผลเล็ก",
        },
        {
          label: "โพรพิเนบ 70",
          value: "12",
          description: "ใช้ในอัตรา 50 กรัมต่อน้ำ 20 ลิตร พ่นทุก 7 วัน",
          property: "สมรถป้องกันการระบาดของโรคใบไหม้แผลเล็ก",
        },
        {
          label: "โพรพิโคนาโซล 25%",
          value: "13",
          description:
            "ใช้ในอัตรา 20 ซีซี. ต่อน้ำ 20 ลิตร เมื้อพบการแพร่ระบาดของโรคใบไหม้แผลใหญ่",
          property: "ป้องกันกำจัดโรคใบไหม้แผลใหญ่",
        },
        {
          label: "คาร์เบนดาซิม-เอฟ",
          value: "14",
          description:
            "ใช้ในอัตรา 25 ซีซี ต่อน้ำ 20 ลิตร พ่นป้องกันการระบาดของโรคใบไหม้แผลใหญ่",
          property: "สามารถป้องกันกำจัดโรคใบไหม้แผลใหญ่",
        },
        {
          label: "อีโปนอล",
          value: "15",
          description:
            "ใช้ในอัตรา 20 มล ต่อน้ำ 20 ลิตร พ่นป้องกันการระบาดของโรคใบไหม้แผลใหญ่",
          property: "สามารถป้องกันกำจัดโรคใบไหม้แผลใหญ่",
        },
        {
          ...
          value: "16",
          description:
            "ใช้ในอัตรา 5-10 มิลลิลิตร ต่อน้ำ 20 ลิตร พ่นป้องกันการระบาดของโรคใบไหม้แผลใหญ่ พ่นซ้ำทุก 10 วัน",
          property: "สามารถป้องกันโรคใบไหม้แผลใหญ่",
        },
        {
          label: "เอ็กซ์มาลา",
          value: "17",
          description:
            "ใช้ในอัตรา 20 มิลลิตร ต่อน้ำ 20 ลิตร พ่นป้องกันการระบาดของแมลงศัตรูพืช เพลี้ยอ่อนข้าวโพดและเพลี้ยอ่อน",
          property:
            "สามารถป้องกันกำจัดเพลี้ยอ่อนข้าวโพดและเพลี้ยอ่อนที่เป็นพาหะของโรคใบด่างแคระและโรคใบด่างอ้อย",
        },
        {
          label: "ลีน่อน",
          value: "18",
          description:
            "ใช้ในอัตรา 20-30 ซีซี ต่อน้ำ 20 ลิตร พ่นป้องกันกำจัดเพลี้ยอ่อนข้าวโพดและเพลี้ยอ่อน ถ้าพบการระบาดอย่างรุนแรงใช้ในอัตรา 40-50 ซีซี ผสมน้ำ 20 ลิตร ทุก 7 วัน",
          property:
            "สามรถป้องกันกำจัดเพลี้ยอ่อนข้าวโพดและเพลี้ยอ่อนที่เป็นพาหะของโรคใบด่างแคระและโรคใบด่างอ้อย",
        },
        {
          label: "คาร์บาริล (85% WP)",
          value: "19",
          description:
            "ใช้ในอันตรา 50 กรัมต่อน้ำ 20 ลิตร พ่นเฉพาะบริเวณที่เพลี้ยอ่อนลงทำลาย เมื่อพบความหนาแน่นของเพลี้ยอ่อนข้าวโพดและเพลี้อ่อนมากกว่า 25% ของพื้นที่ใบทั้งต้น โดยเฉพาะระยะที่ข้าวโพดแทงช่อดอกตัวผู้",
          property:
            "สามารถป้องกันกำจัดเพลี้ยอ่อนข้าวโพดและเพลี้ยอ่อนที่เป็นพาหะของโรคใบด่างแคระและโรคใบด่างอ้อย",
        },
        {
          ...
          value: "20",
          description:
            "ใช้อัตรา 30-50 ซีซี. ต่อน้ำ 20 ลิตร พ่นป้องกันกำจัดการระบาดของเพลี้ยอ่อนข้าวโพดและเพลี้ยอ่อน",
          property:
            "สามารถป้องกันกำจัดเพลี้ยอ่อนและเพลี้ยอ่อนข้าวโพดที่เป็นพาหะของโรคใบด่างแคระและโรคใบด่างอ้อย",
        },
        {
          label: "แอนทราโคล",
          value: "21",
          description: "ใช้ในอัตรา 30 กรัมต่อน้ำ 20 ลิตร พ่นทุก 7-10 วัน",
          property: "สามารถป้องกันกำจัดโรคใบไหม้แผลใหญ่",
        },
      ],
