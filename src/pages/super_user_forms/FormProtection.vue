                    ...
                    >
                      ...
                      <div class="row">
                        <div class="col-md-12 col-xs-12 q-pa-xs">
                          <q-select
                            filled
                            v-model="modelProtection"
                            :options="optionsProtection"
                            label="ป้องกันด้วยเขตกรรม"
                          />
                        </div>
                      </div>
                      <!--  ชนิดของโรค + คำอธิบายวิธีการป้องกัน + ประโยชน์ของการป้องกัน-->
                      <div class="row">
                        <!-- ชนิดของโรค  -->
                        <div class="col-md-6 col-xs-12 q-pa-xs">
                          <q-badge
                            color="blue"
                            multi-line
                            v-if="modelProtection"
                          >
                            ชนิดของโรค: "{{ modelProtection.label }}"
                          </q-badge>
                        </div>
                      </div>
                      <div class="row">
                        <!-- คำอธิบายวิธีการป้องกัน -->
                        <div class="col-md-6 col-xs-12 q-pa-xs">
                          <q-badge
                            color="blue"
                            multi-line
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 col-xs-12 q-pa-xs">
                          <q-badge
                            ...
                            v-if="modelProtection"
                          >
                            ประโยชน์ของการป้องกันด้วยเขตกรรม: "{{
                              modelProtection.advancted
                            }}"
                          </q-badge>
                        </div>
                      </div>
      ...
      optionsProtection: [
        {
          ...
          value: "1",
          description:
            "1.หลีกเลี่ยงการปลูกก่อนฝนตกชุก 2.กำจัดพืชอาศัยเพื่อลดการอยู่ข้ามฤดูของเชื้อสาเหตุโรค 3.ใช้เมล็ดพันธุ์ที่ได้จากต้นที่ปราศจากโรค หลีกเลี่ยงการใช้เมล็ดพันธุ์จากแหล่งที่พบการระบาด 4.ใช้เมล็ดพันธุ์ที่ตากแห้งสนิทความชื้น 12 เปอร์เซ็นต์ ป้องกันเชื้อที่ติดมากับเมล็ดพันธุ์ 5.สายพันธุ์ที่ต้านทานต่อโรค 6.ถ้าพบการระบาดของโรคในแปลงให้ถอนต้นกล้าข้าวโพดที่แสดงอาการของโรคออกไปเผาทาลายนอกแปลงปลูกทันที 7.หมั่นตรวจแปลงตั้งแต่เริ่มปลูก",
          advancted:
            "ลดการแพร่ระบาด ลดการอยู่ข้ามฤดูของเชื้อสาเหตุโรค ป้องกันเชื้อที่ติดมากับเมล็ดพันธุ์ และลดการสูญเสียผลผลิต",
        },
        {
          label: "โรคราสนิม",
          value: "2",
          description:
            "1.หลีกเลี่ยงการปลูกในปลายฤดูฝนที่มีการระบาดของโรคอย่างรุนแรง 2.หลีกเลี่ยงการปลูกข้าวโพดพันธุ์อ่อนแอ 3.หมั่นตรวจแปลงตั้งแต่เริ่มปลูกถ้าพบข้าวโพดหวานเริ่มแสดงอาการของโรค ควรพ่นด้วยสารป้องกันกำจัด 4.กำจัดต้นข้าวโพดที่เป็นโรคราสนิมเผานอกแปลง 5.ใช้พันธุ์ต้านทานโรค",
          advancted:
            "ลดการแพร่ระบาด ป้องกันการระบาดของโรคอย่างรุนแรง และลดความเสียหายของผลผลผลิต",
        },
        {
          label: "โรคใบไหม้แผลใหญ่",
          value: "3",
          description:
            "1.ปลูกพืชหมุนเวียน 2.เผาทำลายเศษซากพืชเป็นโรค 3.ใช้พันธุ์ต้านทานต่อโรค 4.ทำลายพืชอาศัยของเชื้อ เช่น หญ้าเดือย 5.หมั่นตรวจแปลงอยู่เสมอตั้งแต่ระยะกล้า",
          advancted:
            "ลดการแพร่ระบาด ป้องกันการแพร่ระบาดของเชื้อสาเหตุโรค และลดความเสียหายของผลผลผลิต",
        },
        {
          label: "โรคใบไหม้แผลเล็ก",
          value: "4",
          description:
            "1.ใช้เมล็ดพันธุ์จากต้นที่สมบูรณ์ปราศจากโรค 2.หมั่นตรวจแปลงอยู่เสมอ พบการระบาดของโรคระยะกล้าให้ถอนเผาทำลาย 3.ทำลายเศษซากของข้าวโพดหลังเก็บเกี่ยว 4.หลีกเลี่ยงการปลูกข้าวโพดหวานในแหล่งที่มีการระบาดของโรค 5.ทำลายพืชอาศัยของโรค เช่น หญ้าเดือย",
          advancted:
            "ลดการแพร่ระบาด ป้องกันการแพร่ระบาดของเชื้อสาเหตุโรค และลดความเสียหายของผลผลผลิต",
        },
        {
          ...
          value: "5",
          description:
            "1.กำจัดพืชที่เป็นแหล่งอาศัยของเชื้อ เช่น หญ้าจอนห์สัน 2.กำจัดเพลี้ยอ่อนข้าวโพดที่เป็นแมลงพาหะนำโรค 3.ปลูกพืชหมุนเวียน 4.ใช้เมล็ดพันธุ์ต้านทานโรค 5.หลีกเลี่ยงการปลูกข้าวโพดในช่วงที่มีการระบาดของแมลงพาหะ",
          advancted:
            "ลดการแพร่ระบาด ป้องกันกำจัดแมลงพาหะนำโรค และลดความเสียหายของผลผลผลิต",
        },
        {
          label: "โรคใบด่างลายหรือโรคใบด่างอ้อย",
          value: "6",
          description:
            "1.กำจัดพืชที่เป็นแหล่งอาศัยของเชื้อ เช่น หญ้าจอนห์สัน 2.กำจัดเพลี้ยอ่อนข้าวโพด ซึ่งเป็นแมลงพาหะนำโรค 3.ปลูกพืชหมุนเวียน 4.ใช้เมล็ดพันธุ์ต้านทานโรค 5.หลีกเลี่ยงการปลูกข้าวโพดในช่วงที่มีการระบาดของแมลงพาหะ",
          advancted:
            "ลดการแพร่ระบาด ป้องกันกำจัดแมลงพาหะนำโรค และลดความเสียหายของผลผลผลิต",
        },
      ],
