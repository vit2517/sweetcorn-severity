...
export default {
  ...
  methods: {
    ...
    getPlan_career(member_id) {
      ...
      axios
        ...
        .then(function (res) {
          ...
          console.log(
            "get_plan_career_by_member_id++++:",
            self.plan_careers.options
          );
    ...
    onCareer_plan(plan_career) {
      if (plan_career) {
        ...
        console.log("ca_plan_group:", this.ca_group_name);
      } else {
    ...
    onQualification(qualification) {
      if (qualification) {
        ...
        console.log("qualification_group_name:", this.qualification_group_name);
      } else {
  ...
  created() {
    ...
    var folder = "icp_v1_suser/qa_plan_career_form/";
