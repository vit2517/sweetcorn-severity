...
export default {
  ...
  methods: {
    ...
    submitForm() {
      this.plan_career.start_date = this.yearToDay(this.plan_career.start_date);
      if (!this.isEdit) {
        this.$q
          .dialog({
            title: "ยืนยัน",
  ...
  created() {
    ...
    var folder = "icp_v1_suser/plan_career_form/";
