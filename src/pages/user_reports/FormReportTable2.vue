                        ...
                        <template v-slot:top-right="props">
                          <!-- <div class="col-md-4 col-xs-4 q-pa-xs">
                            <q-select
                              ...
                              emit-value
                              map-options
                              @update:model-value="(val) => on_full_name(val)"
                            >
                          ...
                          <div class="col-md-4 col-xs-4 q-pa-xs">
                            ...
                            >
                              ...
                              <template v-slot:append>
                                <q-icon
                                  name="close"
                                  @click.stop.prevent="on_qualification_names_"
                                  class="cursor-pointer"
                                />
                              </template>
                            </q-select>
...
export default {
  ...
  data() {
    return {
      title: "รายงานผลการประเมินตนเอง(ผู้ใช้ทั่วไป)",
      filter: ref(""),
      loading: ref(false),
      url_api_pivot: "",
      url: "",
  ...
  created() {
    ...
    var folder = "icp_v1/FormReportTable2/";
