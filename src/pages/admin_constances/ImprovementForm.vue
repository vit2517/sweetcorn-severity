                      ...
                      <div class="row">
                        <div class="col-md-9 col-xs-12 q-pa-xs">
                          <q-input
                            ...
                            standout
                            bottom-slots
                            v-model="individual.perform_name"
                            label="ผลการประเมิน *"
                            clearable
                            :rules="[
                              (val) =>
                        ...
                        <div class="col-md-3 col-xs-12 q-pa-xs">
                          <q-input
                            ...
                            standout
                            bottom-slots
                            v-model="individual.perform_value"
                            label="ค่าการประเมิน *"
                            clearable
                            mask="#"
                            fill-mask
                      ...
                      >
                        <template v-slot:top-right="props">
                          <q-input
                            ...
                            debounce="300"
                            v-model="filter"
                            placeholder="ค้นหาค่าผลการประเมิน"
                          >
                            <template v-slot:append>
                              <q-icon name="search" />
                            </template>
                        ...
                        <template v-slot:body-cell-actions="props">
                          <q-td :props="props">
                            <q-btn
                              icon="mode_edit"
                              label="แก้ไข"
                              @click="editUser(props.row.perform_id)"
                            ></q-btn>
                            <q-btn
                              icon="delete"
                              label="ลบ"
...
export default {
        ...
        this.$q
          ...
          .onOk(() => {
            ...
            axios
              .post(this.url_api_individual, {
                action: "update",
                perform_id: this.individual.perform_id,
                perform_name: this.individual.perform_name,
                perform_value: this.individual.perform_value,
              })
              .then((response) => {
    ...
    editUser(perform_id) {
      ...
      axios
        ...
        .then(function (response) {
          ...
          self.individual.perform_id = response.data.perform_id;
          self.individual.perform_name = response.data.perform_name;
          self.individual.perform_value = response.data.perform_value;
        })
        .catch(function (error) {
          console.log(error);
        });
    },
    deleteUser(perform_id, perform_name) {
      this.$q
        .dialog({
          title: "ยืนยัน",
          message:
  ...
  created() {
    ...
    var folder = "icp_v1_admin_constances/ImprovementForm/";
