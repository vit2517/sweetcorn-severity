...
export default {
  ...
  data() {
    return {
      modelChemical: ref(null),
      optionsChemical: [
        {
          label: "เมทาแลกซิล 35% ดีเอส",
          value: "1",
          description:
            "ป้องกันกำจัดโรคราน้ำค้าง,ใช้เมทาแลกซิลในอัตรา 7-10 กรัม/เมล็ด 1 กิโลกรัม คลุกเมล็ดก่อนปลูกสามารถป้องกันกาจัดโรคราน้ำค้างได้ตลอดฤดูปลูกและเมื่อข้าวโพดอายุ ๅ สัปดาห์ให้พ่นทุกสัปดาห์ติดต่อกันจำนวน 4 สัปดาห์ สามารถป้องกันโรคราน้ำค้างได้ดีที่สุด",
          category: "1",
        },
        {
          ...
          value: "2",
          description:
            "ป้องกันกำจัดโรคราน้ำค้าง,ใช้ในอัตรา 3-5 มิลลิลิตรต่อเมล็ดพันธุ์ 1 กิโลกรัม คลุกเมล็ดก่อนปลูกสามารถป้องกันกำจัดโรคราน้ำค้าง",
          category: "2",
        },
        {
