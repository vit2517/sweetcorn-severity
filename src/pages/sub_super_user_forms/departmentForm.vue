                      ...
                      <div class="row">
                        ...
                        <div class="col-md-12 col-xs-12 q-pa-xs">
                          <q-input
                            ...
                            standout
                            bottom-slots
                            v-model="individual.department_name"
                            label="สาขาวิชา *"
                            clearable
                            :rules="[
                              (val) =>
                      ...
                      >
                        <template v-slot:top-right="props">
                          <q-input
                            ...
                            debounce="300"
                            v-model="filter"
                            placeholder="ค้นหาข้อมูลสาขาวิชา"
                          >
                            <template v-slot:append>
                              <q-icon name="search" />
                            </template>
                        ...
                        <template v-slot:body-cell-actions="props">
                          <q-td :props="props">
                            <q-btn
                              icon="mode_edit"
                              label="แก้ไข"
                              @click="editUser(props.row.department_id)"
                            ></q-btn>
                            <q-btn
                              icon="delete"
                              label="ลบ"
...
export default {
  ...
  data() {
    return {
      ...
      url_api_member: "",
      // ------------------------------------------------------------------------------
      title: "ข้อมูลสาขาวิชา(ผู้ดูแลกลุ่ม)",
      email: "",
      username: "",
      password: "",
      repassword: "",
  ...
  created() {
    ...
    var folder = "icp_v1_sub_admin/department/";
